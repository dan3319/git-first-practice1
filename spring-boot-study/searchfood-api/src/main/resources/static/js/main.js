...
var wishListResult = new Vue({
    ...
    filters: {
            ...
            yyyyMMddHHmmss: function(value) {
                ...
                // 월, 일, 시간, 분, 초의 경우 한자리 수 값이 있기 때문에 공백에 0 처리
                if(month < 10){ month = '0' + month;}
                if(day < 10){day = '0' + day;}
                if(hour < 10){day = '0' + hour;}
                if(minute < 10){day = '0' + minute; }
                if(second < 10){day = '0' + second;}
...
// 방문 추가 버튼 눌렀을 때 방문 횟수 +1 되기 / 안됨
//function visitPius(id){
//    console.log('with visit btn click', id);
//
//    $.ajax({
//            type: 'post',
//            url: '/api/VisitPlus',
...
//            contentType: 'application/json',
//            success: function(response, status, xhr) {
//                console.log('방문 횟수 추가 완료', response);           // WishListVO
//
//                alert('방문 횟수가 추가되었습니다');
//
//
//                getWishList();
//
